...
async function starts() {
	...
	nzwa.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⏳ Espera ai tome um cafe☕  com Lorde screamo⏳',
